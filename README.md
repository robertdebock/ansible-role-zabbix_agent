...
|------|------|-------|---------|
|[![travis](https://travis-ci.org/robertdebock/ansible-role-zabbix_agent.svg?branch=master)](https://travis-ci.org/robertdebock/ansible-role-zabbix_agent)|[![github](https://github.com/robertdebock/ansible-role-zabbix_agent/workflows/Ansible%20Molecule/badge.svg)](https://github.com/robertdebock/ansible-role-zabbix_agent/actions)|![quality](https://img.shields.io/ansible/quality/35761)|![downloads](https://img.shields.io/ansible/role/d/35761)|
